...
void main() async {
  const apiKey = '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';
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      final testResponse = await http.post(
        ...
        body: jsonEncode({
          ...
          'messages': [
            {
              'role': 'user',
              'content': 'Create 1 multiple choice question about science. Format: Question: [question] A) [option] B) [option] C) [option] D) [option] Correct: [A/B/C/D]'
            }
          ],
          'temperature': 0.7,
          'max_tokens': 300,
      ...
      if (testResponse.statusCode == 200) {
        ...
        final content = genData['choices']?[0]?['message']?['content'] as String?;
